...
git clone https://github.com/IlmarLopez/utt-access-control-server

cd utt-access-control-server
...
- `GET /v1/buildings`: returns a paginated list of the buildings
- `GET /v1/buildings/:id`: returns the detailed information of an building
- `POST /v1/buildings`: creates a new building
- `PUT /v1/buildings/:id`: updates an existing building
- `DELETE /v1/buildings/:id`: deletes an building
- `GET /v1/building-accesses`: returns a paginated list of the building accesses
- `GET /v1/building-accesses/:id`: returns the detailed information of an building access
- `POST /v1/building-accesses`: creates a new building access
- `PUT /v1/building-accesses/:id`: updates an existing building access
- `DELETE /v1/building-accesses/:id`: deletes an building access
- `GET /v1/careers`: returns a paginated list of the careers
- `GET /v1/careers/:id`: returns the detailed information of an career
- `POST /v1/careers`: creates a new career
- `PUT /v1/careers/:id`: updates an existing career
- `DELETE /v1/careers/:id`: deletes an career
- `GET /v1/roles`: returns a paginated list of the roles
- `GET /v1/roles/:id`: returns the detailed information of an role
- `POST /v1/roles`: creates a new role
- `PUT /v1/roles/:id`: updates an existing role
- `DELETE /v1/roles/:id`: deletes an role
- `GET /v1/users/me`: returns the detailed information of current user with token access
- `GET /v1/users`: returns a paginated list of the users
...
# with the above JWT token, access the user resources, such as: GET /v1/users
curl -X GET -H "Authorization: Bearer ...JWT token here..." http://localhost:8080/v1/users
...
│   ├── building            building-related features
│   ├── buildingaccess            buildingaccess-related features
│   ├── career            career-related features
...
the `user` directory contains the application logic related with the user feature.
...
1. Develop the service that implements the business logic supporting the feature. Please refer to `internal/user/service.go` as an example.
2. Develop the RESTful API exposing the service about the feature. Please refer to `internal/user/api.go` as an example.
3. Develop the repository that persists the data entities needed by the service. Please refer to `internal/user/repository.go` as an example.
